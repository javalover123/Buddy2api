...
# Scripts live in scripts\; the project root is one level up.
...
Write-Host "  QClaw / QwenWork Windows logins cannot be read inside Linux Docker; use python -m buddy2api for those."
